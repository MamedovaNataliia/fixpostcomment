...
$module_id = 'ebola.fixpostcomment';
$module_prefix = 'EBOLA_FIXPOSTCOMMENT';
...
$aTabs = [
    [
        ...
        "OPTIONS" => [
            [
                $module_prefix."SHIFT_DAYS",
                'Время закрепления постов (в днях, 0 (по умолчанию) - без ограничений)',
                "",
                ["text", 10],
            ],
        ],
